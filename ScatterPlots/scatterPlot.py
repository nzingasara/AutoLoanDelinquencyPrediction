...
plot(np_loan_amnt0s, np_annual_inc0s, "blue", "non-delinquent", ax)
...
plot(np_loan_amnt0s, np_int_rate0s, "blue", "non-delinquent", ax)
...
plot(np_loan_amnt0s, np_disbursal_timestamp0s, "blue", "non-delinquent", ax)
...
plot(np_loan_amnt0s, np_credit_score0s, "blue", "non-delinquent", ax)
...
plot(np_annual_inc0s, np_int_rate0s, "blue", "non-delinquent", ax)
...
plot(np_annual_inc0s, np_disbursal_timestamp0s, "blue", "non-delinquent", ax)
...
plot(np_annual_inc0s, np_credit_score0s, "blue", "non-delinquent", ax)
...
plot(np_int_rate0s, np_disbursal_timestamp0s, "blue", "non-delinquent", ax)
...
plot(np_int_rate0s, np_credit_score0s, "blue", "non-delinquent", ax)
...
plot(np_disbursal_timestamp0s, np_credit_score0s, "blue", "non-delinquent", ax)
