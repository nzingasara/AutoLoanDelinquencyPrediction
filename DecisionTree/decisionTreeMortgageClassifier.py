...
if __name__ == "__main__":
    ...
    # load the data
    df_data, uniques = load_data("mortgage_data_small.csv")
    ...
    plot_max_depth_learning_curve("Decision Tree F1 Score as Function of Max Depth", "max depth", "f1 score", X_df_,
